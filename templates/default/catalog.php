                        ...
                        <div class="catalog-aside__wrap">
                            <div class="catalog-aside-block">
                                ...
                                <div class="catalog-aside-block__content catalog-aside-block__drop">
                                    ...
                                    <form action="<?=$this->alias('catalog' . (!empty($this->parameters['alias']) ? '/' . $this->parameters['alias'] : ''))?>"
                                          class="catalog-filter">

                                        <?php if (!empty($catalogPrices)): ?>
                                            <div class="catalog-filter-item catalog-filter-item_open">
                                                <div class="catalog-filter-item__title">Цена
                                        ...
                                        <?php if (!empty($catalogFilters)): ?>
                                            ...
                                            <div class="catalog-filter-item">
                                                <div class="catalog-filter-item__title"><?=$item['name']?>
                                                    <span class="catalog-filter-item__toggle"></span>
                                                </div>
                                                <div class="catalog-filter-item__content">
                                                        ...
                                                        <li class="catalog-filter-item__unit">
                                                            <label class="catalog-filter-item__check checkbox">
                                                                <input type="checkbox"
                                                                       ...
                                                                       value="<?=$value['id']?>"
                                                                       <?=!empty($_GET['filters']) &&
                                                                          in_array($value['id'], $_GET['filters']) ? 'checked' : '' ?>
                                                                       class="checkbox__box visually-hidden">
                                                                <span class="checkbox__span"></span>
                                                                <span class="checkbox__text"><?=$value['name']?></span>
                                                                <span class="checkbox__type">(<?=$value['count'] ?? 0 ?>)</span>
                                                            </label>
                                                        </li>
                                                    <?php endforeach ?>
                                                    </ul>
