                    ...
                    <div class="basket-top">
                        ...
                        <div class="total-basket-price">
                            <?php if (!empty($this->cart['total_old_sum'])):?>
                                Итого:
                                <span class="total-basket-price_old-price" data-totalOldSum>
                                    <?=$this->cart['total_old_sum']?> руб.
                                </span>
                            <?php endif;?>
                            <span class="total-basket-price_new-price" data-totalSum>
                                <?=$this->cart['total_sum']?> руб.
                            </span>
                        </div>
                    ...
                    <div class="catalog-section__wrapper">
                      ...
                      <span class="card-main-info-size__control card-main-info-size__control_plus js-counterIncrement"
                            data-quantityPlus></span>
                                        ...
                                        <?php endif; ?>
                                        <a style="display: none" data-addToCart="<?=$item['id']?>" data-toCartAdded
                                           href="#" class="card-main-info__button button-basket button-blue button-big button">
        ...
        <section class="order-registration">
            <div class="container">
                <form class="order-registration-form">
                            ...
                            <div class="order-registration-radio">
                                <?php foreach($this->payments as $key => $item):?>
                                    <label class="order-registration-radio-item">
                                        <input class="order-registration-rad-inp"
                                               type="radio"
                                               name="payments_id"
                                               <?=!$key ? 'checked' : ''?>
                                        >
                    ...
                    <input class="execute-order_btn"
                           type="button"
                           value="Оформить заказ"
                           data-popup="order-popup"
                    >
