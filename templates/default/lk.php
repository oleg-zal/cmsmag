    ...
    <section class="section">
        <div class="container">
            <div class="wrapper_internal wrapper_lk">
                ...
                <?php if (empty($orders)): ?>
                    <p>Вы еще не совершали покупки в нашем интернет магазине</p>
                <?php else: ?>
                            ...
                            <div class="active" data-innerswitched="order_switch1">
                                ...
                                <ul class="info_panel">
                                    <li>
                                        ...
                                        <span class="info">Всего товаров: <?=$currentOrder['total_qty'] ?? 0?></span>
                                    </li>
                                    <li>
                                        <span class="name"> Стоимость:</span>
                                        <span class="info"><?=$currentOrder['total_sum']?> ₽</span>
                                    </li>
                                    <li>
                                        <span class="name">Дата формирования:</span>
                                        <span class="info"><?=$currentOrder['date']?></span>
                                    </li>
                                    <li>
                                        <span class="name">Статус:</span>
                                        <span class="info"><?=$currentOrder['join']['orders_statuses']['name']?></span>
                                    </li>
                                </ul>
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <?php foreach($currentOrder['join']['orders_goods'] as $item): ?>
                                                    <tr>
                                                        <td><?=$item['id']?></td>
                                                        <td><div class="flex_wrap"><b><?=$item['name']?></b></div></td>
                                                        <td><?=$item['qty']?>шт</td>
                                                        <td><?=$item['price']?> ₽</td>
                                                    </tr>
                                                <?php endforeach ?>
                                ...
                                <div class="table_total">
                                    <div class="delivery">
                                        <div>
                                            <b>Способ оплаты:</b>
                                            <span><?=$currentOrder['join']['payments']['name']?></span>
                                        </div>
                                        <div>
                                            <b>Способ получения: </b>
                                            <span><?=$currentOrder['join']['delivery']['name']?></span>
                                        </div>
                                    </div>
                                    <div class="totally">
