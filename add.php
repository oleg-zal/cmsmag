<form id="main-form" class="vg-wrap vg-element vg-ninteen-of-twenty" method="post" action="/admin/edit" enctype="multipart/form-data">
    ...
    <input id="tableId" type="hidden" name="id" value="53">

    <input type="hidden" name="table" value="goods">

    <div class="vg-wrap vg-element vg-rows"><div class="vg-full vg-firm-background-color4 vg-box-shadow"><div class="vg-element vg-full vg-box-shadow">
                <div class="vg-wrap vg-element vg-full vg-box-shadow">
                    ...
                    <div class="vg-element vg-full">
                        <div class="vg-element vg-full vg-left ">
                            <input type="text" name="name" class="vg-input vg-text vg-firm-color1" value="good_new">
                        </div>
                    </div>
                </div>
            </div><div class="vg-element vg-full vg-box-shadow">
            ...
            </div><div class="vg-wrap vg-element vg-full vg-box-shadow">
                <div class="vg-wrap vg-element vg-full vg-box-shadow">
                    <div class="vg-wrap vg-element vg-full">
                        <div class="vg-element vg-full vg-left">
                            <span class="vg-header">Ключевые слова</span>
                        </div>
                        <div class="vg-element vg-full vg-left">
                    ...
                    <div class="vg-element vg-full">
                        <div class="vg-element vg-full vg-left" style="flex-wrap: wrap">
                            ...
                            <textarea name="keywords" class="vg-input vg-text vg-full vg-firm-color1"></textarea>
                        </div>
                    </div>
                </div>
            </div><div class="vg-element vg-full vg-box-shadow img_wrapper">
                <div class="vg-wrap vg-element vg-full">
                    <div class="vg-wrap vg-element vg-full">
                        <div class="vg-element vg-full vg-left">
                    ...
                    <div class="vg-wrap vg-element vg-full gallery_container">
                        <label class="vg-dotted-square vg-center" draggable="false">
                            ...
                            <input class="gallery_img" style="display: none;" type="file" name="gallery_img[]" multiple="" accept="image/*,image/jpeg,image/png,image/gif" draggable="false">
                        </label>
                        ...
                        <a href="/admin/delete/goods/53/gallery_img/Zm90bzEucG5n" class="vg-dotted-square vg-center" draggable="true">
                            <img class="vg_delete" src="/userfiles/foto1.png" draggable="false">
                        </a>
                        <a href="/admin/delete/goods/53/gallery_img/MzEtMzExODYxX3dvbWFuLXN0dWRlbnQtaWNvbi1lbW9qaXMtZGUtcHJpbmNlc2FzX2QxY2EwYTZkLnBuZw==" class="vg-dotted-square vg-center" draggable="true">
                            <img class="vg_delete" src="/userfiles/31-311861_woman-student-icon-emojis-de-princesas_d1ca0a6d.png" draggable="false">
                        </a>
                        <a href="/admin/delete/goods/53/gallery_img/Z29vZHMvODQwLTg0MDMxNjlfZG93bmxvYWQtc3ZnLWRvd25sb2FkLXBuZy1kb2N0b3ItZW1vamkucG5n" class="vg-dotted-square vg-center" draggable="true">
                            <img class="vg_delete" src="/userfiles/goods/840-8403169_download-svg-download-png-doctor-emoji.png" draggable="false">
                        </a>
            ...
            </div><div class="vg-element vg-full vg-left vg-box-shadow">
                <div class="vg-wrap vg-element vg-full vg-box-shadow">
                    <div class="vg-element vg-full vg-left">
        ...
        </div></div><div class="vg-wrap vg-element vg-img"><div class="vg-full vg-firm-background-color4 vg-box-shadow"><div class="vg-wrap vg-element vg-full vg-box-shadow img_container img_wrapper">
            ...
            </div><div class="vg-wrap vg-element vg-full vg-box-shadow img_container img_wrapper">
                <div class="vg-wrap vg-element vg-half">
                    <div class="vg-wrap vg-element vg-full">
                        <div class="vg-element vg-full vg-left">
            ...
            </div></div></div><div class="vg-wrap vg-element vg-content"><div class="vg-wrap vg-element vg-full vg-box-shadow">
            <div class="vg-wrap vg-element vg-full vg-box-shadow">
                <div class="vg-wrap vg-element vg-full">
                    <div class="vg-element vg-full vg-left">
